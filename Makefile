...
SOURCE_FILES := main.c drivers/clock.c drivers/gpio.c drivers/uart.c drivers/sram.c drivers/io_board.c drivers/spi.c drivers/oled.c drivers/fonts.c drivers/menu.c drivers/CAN_CTRL.c drivers/CAN_driver.c
